...
app.get("/jokes/:id", (req, res) => {
  // Extract the value of the route parameter ":id" from the request object
  const id = req.params.id;

  // Retrieve the joke data based on the extracted ID
  const jokeData = jokes[parseInt(id) - 1];

  // Send the joke text as a JSON response
  res.json(jokeData['jokeText']);
});
